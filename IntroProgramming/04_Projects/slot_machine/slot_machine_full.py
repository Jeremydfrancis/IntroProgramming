# Source - https://codereview.stackexchange.com/q/97666
# Posted by PyxlWuff, modified by community. See post 'Timeline' for change history
...
def printScore():
    ...
    if (firstWheel == "CHERRY") and (secondWheel != "CHERRY"):
        ...
        (firstWheel == "CHERRY")
        and (secondWheel == "CHERRY")
        and (thirdWheel != "CHERRY")
    ):
        win = 5
        balance = balance - 5
    elif (
        ...
        (firstWheel == "ORANGE")
        and (secondWheel == "ORANGE")
        and ((thirdWheel == "ORANGE") or (thirdWheel == "BAR"))
    ):
        win = 10
        balance = balance - 10
    elif (
        (firstWheel == "PLUM")
        and (secondWheel == "PLUM")
        and ((thirdWheel == "PLUM") or (thirdWheel == "BAR"))
    ):
        win = 14
        balance = balance - 14
    elif (
        (firstWheel == "BELL")
        and (secondWheel == "BELL")
        and ((thirdWheel == "BELL") or (thirdWheel == "BAR"))
    ):
        win = 20
        balance = balance - 20
